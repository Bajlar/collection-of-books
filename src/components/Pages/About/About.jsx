...
/* <div className="text-center">
        ...
        <p className="mt-5 text-lg">
          Books are a uniquely portable magic. Books serve to show a man that
          those original <br /> thoughts of his aren’t very new after all. The
          man who does not read good books is <br /> no better than the man who
          can’t.
        </p>
      </div>
      <div className="grid md:grid-cols-2 gap-10">
        <div className="mt-5 text-lg">
          <h2 className="font-bold">Books are a uniquely portable magic.</h2>
          <p className="mt-4">
            Space, the final frontier. These are the voyages of the Starship
          ...
          <h2 className="font-bold mt-4">Is the Space Pope reptilian!?</h2>
          <p className="mt-4">
        ...
        <div className="mt-5 text-lg">
          <h2 className="font-bold">How much money you got on you?</h2>
          <p className="mt-4">
